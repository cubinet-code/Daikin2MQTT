...
"<div id='l1' name='l1'>"
    "<fieldset>"
        ...
        "<form method='post' name='mqttForm'>"
            "<p><b>_TXT_MQTT_FN_</b>"
                "<br/>"
                "<input id='fn' name='fn' "
            ...
            "</p>"
            "<br/>"
            "<button name='save' type='button' onclick='check()'class='button bgrn'>_TXT_SAVE_</button>"
        "</form>"
    "</fieldset>"
    "<p>"
...
"<div id='l1' name='l1'>"
    "<fieldset>"
        ...
        "<form method='post'>"
            ...
            "<p><b>_TXT_OTHERS_AVAILABILITY_REPORT_</b>"
                "<select name='AVAIL_REPORT'>"
                    "<option value='ON' _HA_AVAIL_REPORT_ON_>_TXT_F_ON_</option>"
                    "<option value='OFF' _HA_AVAIL_REPORT_OFF_>_TXT_F_OFF_</option>"
                "</select>"
            "</p>"
...
"<div id='l1' name='l1'>"
    ...
    "<p><b>_TXT_STATUS_HVAC_</b>"
        " ==> "
        "_HVAC_STATUS_ _HVAC_PROTOCOL_"
    "</p>"
    "<p><b>_TXT_STATUS_MODEL_</b>"
        " ==> "
        "_HVAC_MODEL_"
    "</p>"
        ...
        "<p><b>_TXT_CTRL_FAN_</b>"
            "<form onchange='this.submit()' method='POST'>"
                "<select name='FAN' id='FAN'>"
                    ...
                    "<option value='5' _FAN_5_>:::: _TXT_F_SPEED_ 5</option>"
                "</select>"
            "</form>"
        "</p>"
        "<p><b>_TXT_CTRL_VANE_</b>"
            "<form onchange='this.submit()' method='POST'>"
                "<select name='VANE' id='VANE'>"
                    "<option value='HOLD' _VANE_H_> _TXT_F_HOLD_</option>"
        ...
        "<p><b>_TXT_CTRL_WVANE_</b>"
            "<form onchange='this.submit()' method='POST'>"
                "<select name='WIDEVANE' id='WIDEVANE'>"
                    "<option value='HOLD' _WVANE_H_> _TXT_F_HOLD_</option>"
...
"if (_X50_PROTOCOL_) {"
    ...
    "options = document.getElementById('FAN').options;"
    "options[1].disabled = (options[1].value == 'QUIET');"

    "document.getElementById('VANE').disabled = true;"
    "document.getElementById('WIDEVANE').disabled = true;"
"}"
"</script>"
;
        ...
        "<form method='post'>"
           "<p>"              
            ...
            "<p><b>_TXT_UNIT_STEPTEMP_</b>"
                "<br/>"
                "<input type='number' id='temp_step' step='0.5' name='temp_step' placeholder=' ' value='_TEMP_STEP_'>"
            "</p>"
            "<p><b>_TXT_UNIT_INSIDE_OFFSET_</b>"
                "<br/>"
                "<input type='number' id='inside_offset' step='0.5' name='inside_offset' placeholder='0' value='_INSIDE_OFFSET_'>"
            "</p>"
            "<p><b>_TXT_UNIT_OUTSIDE_OFFSET_</b>"
                "<br/>"
                "<input type='number' id='outside_offset' step='0.5' name='outside_offset' placeholder='0' value='_OUTSIDE_OFFSET_'>"
            "</p>"
            "<p>"
            ...
            "</p>"
            "<p>"
                "<b>_TXT_UNIT_FAN_LEVELS_</b>"
                "<select name='fan_levels'>"
                    "<option value='3' _FAN_3_>3</option>"
                    "<option value='5' _FAN_5_>5</option>"
                "</select>"
            "</p>"
            "<p>"
                ...
                "<select name='update_int'>"
                    ...
                    "<option value='10' _UPDATE_10S_>_TXT_F_10_S</option>"
                    ...
                    "<option value='60' _UPDATE_60S_>_TXT_F_60_S</option>"
                "</select>"
            "</p>"
...
const char html_page_logging[] PROGMEM =
"<script>"
    "getLogs();"
    "window.setInterval(getLogs, 5000);"
    "function getLogs() {"
        // "fetch('/api/logs').then(response => document.getElementById('logArea').value=response.data;);"
        "fetch('/api/logs').then(response => response.text())"
                ".then((response) => { var textarea = document.getElementById('logArea'); textarea.value=response; textarea.scrollTop  = textarea.scrollHeight;"
                "});"
...
"</script>"
    "<div id='f1' style='display:block;'>"
        "<fieldset>"
            "<legend><b>&nbsp; _TXT_LOGGING_TITLE_ &nbsp;</b></legend>"
            "<textarea id='logArea' readonly='true' cols='70'></textarea>"
        "</fieldset>"
        "<p>"
            "<a class='button back' href='/'>_TXT_BACK_</a>"
        "</p>"
